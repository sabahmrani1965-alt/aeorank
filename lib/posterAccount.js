...
// null) and the apply-poster approval route (referredBy: the referring
// poster's id; redditUsername: from the application's verified Reddit
// account).
export async function createOrPromotePoster({ email, referredBy = null, redditUsername = null, origin }) {
