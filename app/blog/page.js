...
const posts = [
  { tag: 'AEO · Strategy', emoji: '🤖', title: 'How to Get Your SaaS Brand Cited by ChatGPT in 2026', excerpt: 'A step-by-step guide to building entity authority, creating answer-first content, and securing the citations that make ChatGPT recommend your product.', date: 'April 10, 2026', readTime: '8 min read', slug: 'how-to-get-cited-by-chatgpt' },
  { tag: 'AEO · Measurement', emoji: '📈', title: 'How to Measure AI Citation ROI: A Framework for SaaS Marketers', excerpt: 'AI citations are worthless if you can\'t measure their business impact. Here\'s the exact framework we use to tie AEO directly to pipeline and revenue.', date: 'April 3, 2026', readTime: '6 min read', slug: 'measure-ai-citation-roi' },
  { tag: 'Entity SEO · AEO', emoji: '🔍', title: 'Entity Authority: The Hidden Driver Behind Every AI Citation', excerpt: 'Why some brands get cited constantly by AI engines while others never appear — and what you can do to build the entity authority that makes the difference.', date: 'March 27, 2026', readTime: '10 min read', slug: 'entity-authority-ai-citation' },
  { tag: 'AEO · Perplexity', emoji: '⚡', title: 'How to Optimize for Perplexity AI: A B2B SaaS Guide', excerpt: 'Perplexity is becoming the preferred research tool for technical buyers. Here\'s how to make sure your brand shows up when they search for solutions like yours.', date: 'March 20, 2026', readTime: '7 min read', slug: 'optimize-for-perplexity' },
  { tag: 'AEO vs SEO', emoji: '🆚', title: 'AEO vs SEO: What\'s Different and Why You Need Both', excerpt: 'AEO and SEO aren\'t competitors — they\'re complements. But they require different strategies. Here\'s how to think about balancing both for maximum visibility.', date: 'March 13, 2026', readTime: '9 min read', slug: 'aeo-vs-seo' },
  { tag: 'Google AI · AEO', emoji: '🌐', title: 'Google AI Overviews: How to Get Featured in SGE Answers', excerpt: 'Google AI Overviews are reshaping organic search. This guide covers exactly what signals Google looks for and how to position your content to get featured.', date: 'March 6, 2026', readTime: '11 min read', slug: 'google-ai-overviews-guide' },
]
